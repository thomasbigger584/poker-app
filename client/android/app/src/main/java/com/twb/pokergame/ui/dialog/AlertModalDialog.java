...
public class AlertModalDialog extends DialogFragment {
    private static final String KEY_ALERT_MODAL_TYPE = "com.twb.pokergame.AlertModalType";
    private static final String KEY_ALERT_SUBTITLE = "com.twb.pokergame.Subtitle";
