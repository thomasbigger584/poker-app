...
public class AuthHelper {
    ...
    private void initializeAuth() {
        ...
        AuthorizationServiceConfiguration.fetchFromUrl(configuration.getDiscoveryUri(), this::handleDiscoveryResult, CustomConnectionBuilder.INSTANCE);
    }
    ...
    private void initializeClient() {
        ...
        AuthorizationRequest.Builder builder = new AuthorizationRequest.Builder(authStateManager.getCurrent().getAuthorizationServiceConfiguration(), clientId.get(), ResponseTypeValues.CODE, configuration.getRedirectUri());
...
//        VersionedBrowserMatcher.CHROME_BROWSER, VersionedBrowserMatcher.FIREFOX_BROWSER
    ...
    private void performTokenRequest(TokenRequest request, AuthorizationService.TokenResponseCallback callback) {
        ...
        try {
            clientAuthentication = authStateManager.getCurrent().getClientAuthentication();
                ...
                ClientAuthentication.UnsupportedAuthenticationMethod unsupportedAuthenticationMethod) {
