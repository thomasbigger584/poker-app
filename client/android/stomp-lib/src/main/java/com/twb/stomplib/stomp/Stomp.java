...
import com.twb.stomplib.connection.impl.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(com.twb.stomplib.connection.ConnectionProvider connectionProvider) {
