        ...
        <#if realm.password>
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                <div class="form-group">
                    <label for="username" class="${properties.kcLabelClass!}">Cluster Benutzername:</label>
                ...
                <div class="form-group">
                    <label for="password" class="${properties.kcLabelClass!}">Cluster Kennwort:</label>
                ...
                <div class="form-group ${properties.kcFormSettingClass!}">
                  ...
                  <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                      ...
                      <input tabindex="4" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" name="login" id="kc-login" type="submit" value="Login Cluster"/>
                  </div>
            </form>
        </#if>
        </div>
