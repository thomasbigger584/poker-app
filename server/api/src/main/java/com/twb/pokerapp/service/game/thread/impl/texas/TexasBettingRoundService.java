...
public class TexasBettingRoundService {
    ...
    public void runBettingRound(GameThreadParams params, GameThread gameThread) {
        var readTransaction = transactionConfiguration.getReadTx();
        LastAggressorService lastAggressor;
        while (true) {
            lastAggressor = new LastAggressorService(readTransaction, writeTransaction, roundRepository, bettingRoundRepository, playerSessionRepository, playerActionRepository, params, gameThread, dispatcher, messageFactory, texasPlayerActionService, roundService, bettingRoundService);
            try {
                lastAggressor
                        .onPrePlayerTurn()
                        .onWaitPlayerTurn()
        ...
        lastAggressor.finishBettingRound();
    }

    private static class LastAggressorService {
        ...
        public LastAggressorService(TransactionTemplate readTransaction,
                                    ...
                                    GameThreadParams params, GameThread gameThread,
                                    MessageDispatcher dispatcher,
                                    ServerMessageFactory messageFactory, TexasPlayerActionService texasPlayerActionService, RoundService roundService, BettingRoundService bettingRoundService) {
            ...
            this.texasPlayerActionService = texasPlayerActionService;
            this.roundService = roundService;
            this.bettingRoundService = bettingRoundService;
        }

        public LastAggressorService onPrePlayerTurn() throws LastAggressorBreakException {
        ...
        public void finishBettingRound() {
            writeTransaction.executeWithoutResult(new Consumer<TransactionStatus>() {
                @Override
    ...
    private static class LastAggressorBreakException extends RuntimeException {
